...
filename_BG_150 = path_+'report_task_SGLT1_BG_150mV_post.csv'
filename_BG_50 = path_+'report_task_SGLT1_BG_50mV_post.csv'
...
line_cfg[2] = { 'xdata': (filename_150,'x'), 'ydata':(filename_150,'150mV'),
                'color': 'k', 'linestyle': '-',  'legend_label': 'Parent 1992 50mV'}
line_cfg[3] = { 'xdata': (filename_BG_50,'tms'), 'ydata':(filename_BG_50,'I'),
                'color': 'b', 'linestyle': '--',  'legend_label': 'BG_50mV'}
line_cfg[4] = { 'xdata': (filename_BG_150,'tms'), 'ydata':(filename_BG_150,'I'),
                'color': 'r', 'linestyle': '--',  'legend_label': 'BG_150mV'}

plot_cfg[1] = {'ylabel': 'i (nA)', 'xlabel': 'time (s)','show_grid': 'both', 'grid_axis': 'both',

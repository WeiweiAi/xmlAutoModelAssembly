...
Glcos=['1e-6','1e-6','1e-6','1e-6','1e-6','1e-6','1e-6','1e-6',
...
for i in range(len(model_ids_)):
    ...
    changes={'test_volt':{'component':'params_BG','name':'test_volt','newValue':test_volt},
             'hold_volt':{'component':'params_BG','name':'hold_volt','newValue':'-0.05'},
             'Glco':{'component':'params_BG','name':'Glco','newValue':Glco},
             'Nai':{'component':'params_BG','name':'Nai','newValue':'10'},
             'Glci':{'component':'params_BG','name':'Glci','newValue':'1e-6'}
             } 
    ...
    simSetting={'type':'UniformTimeCourse','algorithm':dict_algorithm,'initialTime':0,'outputStartTime':0,'outputEndTime':2,'numberOfSteps':200000}

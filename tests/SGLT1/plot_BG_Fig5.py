...
subtitle_kwargs={}
fig_cfg = {'num_rows': 1, 'num_cols': 1, 'width':5, 'height':4, 'fig_title': None, 'title_y': 0.98, 'fontsize': 10, 
...
line_cfg[4] = { 'xdata': (filename_ss,'V0_Vm'), 'ydata':(filename_ss,'Ii_1'),
                'color': 'g', 'linestyle': '-.',  'legend_label': 'Steady state (1) from bond graph '}

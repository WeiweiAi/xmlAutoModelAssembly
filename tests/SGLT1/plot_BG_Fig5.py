...
subtitle_kwargs={}
fig_cfg = {'num_rows': 1, 'num_cols': 1, 'width':6, 'height':4, 'fig_title': None, 'title_y': 0.98, 'fontsize': 10, 
...
line_cfg[4] = { 'xdata': (filename_BG_fast,'V_E'), 'ydata':(filename_BG_fast,'Ii'),
                'color': 'g', 'linestyle': '-.',  'legend_label': 'Bond graph-fast '}
line_cfg[5] = { 'xdata': (filename_ss_fast,'V0_Vm'), 'ydata':(filename_ss_fast,'Ii'),
                'color': 'b', 'linestyle': '-.',  'legend_label': 'Steady state (37) from bond graph-fast'}


plot_cfg[1] = {'ylabel': 'i (nA)', 'xlabel': 'V (mV)','show_grid': 'both', 'grid_axis': 'both', 
                'line': [1,2,3,4,5], 'legend': [1,2,3,4,5]}

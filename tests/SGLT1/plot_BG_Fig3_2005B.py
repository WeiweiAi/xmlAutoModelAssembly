...
save_fig = {'save_fig': True, 'fig_format': 'png', 'file_path': path_, 'filename': 'BG_fit_fig3_2005A'}
filename = data_path+'Eskandari et al 2005_fig3B.csv'
filename_BG= path_+'fig3_2005B.csv'
...
line_cfg[1] = { 'xdata': (filename,'x'), 'ydata':(filename,'Curve1'),
                'color': 'k', 'linestyle': '-',  'legend_label': 'Eskandari et al 2005'}
line_cfg[2] = { 'xdata': (filename_BG,'V_E'), 'ydata':(filename_BG,'Ii'),
                'color': 'r', 'linestyle': '-.',  'legend_label': 'BG'}


plot_cfg[1] = {'ylabel': 'i (pA)', 'xlabel': 'V (mV)','show_grid': 'both', 'grid_axis': 'both', 
                'line': [1,2], 'legend': [1,2]}

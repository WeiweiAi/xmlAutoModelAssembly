...
save_fig = {'save_fig': True, 'fig_format': 'png', 'file_path': path_, 'filename': 'BG_fit_fig10_sugar'}
filename_50 = data_path+'Fig10_Parent1992_50mV_sugar.csv'
filename_150 = data_path+'Fig10_Parent1992_150mV_sugar.csv'
filename_BG_150 = path_+'report_task_SGLT1_BG_step_fig10_150mV_sugar_post.csv'
filename_BG_50 = path_+'report_task_SGLT1_BG_step_fig10_50mV_sugar_post.csv'
...
plot_cfg[1] = {'ylabel': 'i (nA)', 'xlabel': 'Time (ms)','show_grid': 'both', 'grid_axis': 'both',  'ylim': [-500, 400], 'xlim': [0, 80],

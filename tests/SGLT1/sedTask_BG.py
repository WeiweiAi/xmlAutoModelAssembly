...
model_id = model_name+'_50mV' # This is the model id in the sedml, could be different from the model file name
...
changes={'test_volt':{'component':'params_BG','name':'test_volt','newValue':'0.05'}
         } 
...
outputs={'t':{'component':'SGLT1_BG','name':'t','scale':1},
         'Is_out':{'component':'SGLT1_BG','name':'Is_out','scale':1},         
         'Ii':{'component':'SGLT1_BG','name':'Ii','scale':1},
         'Im':{'component':'SGLT1_BG','name':'Im','scale':1},
         }
...
simSetting={'type':'UniformTimeCourse','algorithm':dict_algorithm,'initialTime':0,'outputStartTime':0,'outputEndTime':0.3,'numberOfSteps':3000}

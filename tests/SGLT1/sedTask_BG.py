...
model_ids_=['_fig3_50mV','_fig3_150mV','_fig4_50mV','_fig4_150mV',]
...
for i in range(len(model_ids_)):
    ...
    outputs={'t':{'component':'SGLT1_BG','name':'t','scale':1},
             ...
             'Is':{'component':'params_BG','name':'Is','scale':1e-6},
             'V0_Vm':{'component':'params_BG','name':'V0_Vm','scale':1e-6},
             'V_E':{'component':'params_BG','name':'V_E','scale':1e-6},
             }

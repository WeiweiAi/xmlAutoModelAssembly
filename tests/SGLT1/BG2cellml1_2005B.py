...
csv_file=file_path+'SGLT1_BG_2005_B.csv'
fmatrix='SLC5_f_chem.csv'
rmatrix='SLC5_r_chem.csv'
CompName,CompType,ReName,ReType,N_f,N_r=load_matrix(file_path+fmatrix,file_path+rmatrix)
AVO=6.022e23
q_tot=20e10 # 5e10 molecules per cell
...
to_cellmlV1_params(comp_dict, model_name='params_BG_2005_B',model_file='params_BG_2005_B.txt',file_path=file_path)
to_cellmlV1_models(comp_dict, model_name='SGLT1_BG_2005_B',model_file='SGLT1_BG_2005_B.txt',params_file='params_BG_2005_B.cellml',file_path=file_path)
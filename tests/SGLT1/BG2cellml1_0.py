...
fmatrix='SLC5_f_0.csv'
rmatrix='SLC5_r_0.csv'
...
csv_file=file_path+'SGLT1_BG_0.csv'
...
to_cellmlV1_params(comp_dict, model_name='params_BG_0',model_file='params_BG_0.txt',file_path=file_path)
to_cellmlV1_models(comp_dict, model_name='SGLT1_BG_0',model_file='SGLT1_BG_0.txt',params_file='params_BG_0.cellml',file_path=file_path)
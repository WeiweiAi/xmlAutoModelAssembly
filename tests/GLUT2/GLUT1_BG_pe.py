...
ss_time={'fit1':10} # The time for the steady state, if not provided, the default value will be used
cost_type='AE' 
...
data_observables_file='report_task_GLUT1_kinetic.csv'
...
dataSourceId_1='v_io_ss'
obs1=[dataSourceId_1,'v_io_ss',None,None,'main','v_io_ss',1]
...
dataSourceId_2='g'
exp1=[dataSourceId_2,'g',None,None,None,'main','K_oi']
exps=[exp1]
...
experimentalConditions_map = [(fileId_observables,dataSourceId_2)]
...
parameterId_1='K_io'
adjustable1=[parameterId_1,'main','K_io',1,10,1.64,'linear',[fitId_1]]
adjustables=[adjustable1]
...
experimentData_files[fileId_observables]['experimentalConditions']=dict_exp
fitExperiments={}
for fit in fits:
    fitId=fit[0]
    type=fit[1]

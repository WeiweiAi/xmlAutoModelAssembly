...
for model_id in range(250):
    ...
    sed_model_id = model_name+f'_{model_id}_oi' # This is the model id in the sedml, could be different from the model file name
    ...
    if model_id == 0:
        ...
        changes={'g_o':{'component':'params_BG','name':'g_o','newValue':f'{model_id/10}'},
                 'g_i':{'component':'params_BG','name':'g_i','newValue':'1e-4'}
             } 
    ...
    outputs={'t':{'component':'GLUT2_BG','name':'t','scale':1},
             ...
             'q_init_Ao':{'component':'GLUT2_BG','name':'q_init_Ao','scale':1/0.09},
             }
    ...
    # The following is to add the task information to the dictionary
    add_sedTask2dict(dict_sedDocument, sed_model_id, model_source,changes,simSetting,outputs)
